...
#            from_path = os.path.join(dirpath, "index.md")
#            rel_dir = os.path.relpath(dirpath, content_root)  # "." for root
#            out_dir = public_root if rel_dir == "." else os.path.join(public_root, rel_dir)
